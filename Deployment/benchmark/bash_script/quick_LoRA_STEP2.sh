...
BASE_MODEL_ID=$(jq -r '.HIGHQUAL_BENCH.BASE_MODEL' "$CONFIG")
LORA_ADAPTER=$(jq -r '.HIGHQUAL_BENCH.ADAPTER' "$CONFIG")
INFO_FILE=$PSCRATCH/$(jq -r '.HIGHQUAL_BENCH.VLLM_INFO_PATH' "$CONFIG")
